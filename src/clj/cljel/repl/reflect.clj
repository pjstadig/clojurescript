(ns cljel.repl.reflect
  (:refer-clojure :exclude [macroexpand])
  (:require [cljel.repl.server :as server]
            [cljel.analyzer :as analyzer]
            [cljel.compiler :as compiler]
...
(defn macroexpand [form]
  "Fully expands a cljel macro form."
...
(defn- compile-and-return
  ...
  [conn form]
  (let [ast (analyzer/analyze {:ns {:name 'cljel.user}} form)
